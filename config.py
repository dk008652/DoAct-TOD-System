...
class _Config:
    ...
    def _multiwoz_damd_init(self):
        ...
        self.h_layer = 500  
        self.wt = 3 # weight for newly defined loss
        self.alpha = 0.2
        self.beta = 0.8  # for RL
        self.start_epoch = 10
        ...
        self.vocab_path_train = './data/multi-woz-2.1-processed/vocab' # data/multi-woz-2.1-processed
        self.vocab_path_eval = None  
        self.data_path = './data/multi-woz-2.1-processed/'
        self.data_file = 'data_for_damd.json'
        self.dev_list = 'data/MultiWOZ_2.1/valListFile.json'
        self.test_list = 'data/MultiWOZ_2.1/testListFile.json'
        self.dbs = {
        ...
        # amalgamation of Domain and system action
        self.eval_load_path = "experiments_DSA/all__sd11_lr0.0001_bs2_ga16/epoch33_trloss0.63_gpt2_wt_2"
        
        self.model_output = 'model_output_e2e_FFFT_fix_bs.json'
        self.eval_per_domain = False

        ### my setting end-to-end evaluation
        self.use_true_prev_bspn = False
        self.use_true_prev_aspn = False  #line modified
        self.use_true_db_pointer = False
        self.use_true_prev_resp = False #line modified
        ...
        self.percentage = 0.10  #line added
        ###
        
        ## dst setting
        self.fix_bs = False  #line modified
        self.use_nodelex_resp = True
        self.max_context_length = 900
        self.fp16 = False #new line added
        ##
        ...
        #self.pad_id = None # new line added
